<template>
    <div>
        <svg @click="vote('up')" :class="{ 'thumbs-up-active': upvoted }" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up thumbs-up" viewBox="0 0 16 16">
            <path
        ...
        <svg @click="vote('down')" :class="{ 'thumbs-down-active': downvoted }" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down thumbs-up" viewBox="0 0 16 16">
            <path
...
export default {
    ...
    computed: {
        ...
        /**
         * Return if the authenticated user has upvoted
         *
         * @returns {boolean}
         */
        upvoted() {
        ...
        /**
         * Return if the authenticated user has downvoted
         *
         * @returns {boolean}
         */
        downvoted() {
    ...
    methods: {
        /**
         * Handle the actual voting process
         *
        ...
        vote( type ) {
            ...
            axios.post( `${APP_URL}/votes/${this.entity_id}/${type}` )
                 .then( ( {data} ) => {
